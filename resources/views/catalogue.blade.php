...
<div class="bg-secondary mt-5">
  ...
  <div class="filter d-flex justify-content-center mt-1 pt-1 gap-2">
    <select class="form-select " style="width: 10rem;" aria-label="Default select example">
    ...
    <select class="form-select " style="width: 10rem;" aria-label="Default select example">
      ...
      <option value="2">Steel Series</option>
  ...
  <div class="catalogue row m-0 d-flex justify-content-center gap-2 mb-5 pb-2 pt-5 mt-3">
    ...
    <a href="#" class="card catalogue-card-template" style="width: 18rem;">
      <div>
