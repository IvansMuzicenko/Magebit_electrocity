...
<div id="cart" class="container m-auto bg-secondary p-3 align-items-center rounded">
    ...
    <div id="cartList" class="list-group d-flex m-auto">
        ...
        <a href="http://localhost:8000/catalogue/1" class="list-group-item list-group-item-action d-flex align-items-center justify-content-between" aria-current="true">
